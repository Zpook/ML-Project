...
if __name__ == "__main__":
    ...
    logisticReg = sklearn.linear_model.LogisticRegression(n_jobs=NUM_WORKERS)
    ...
    logisticReg.fit(AllMaps.flatten(1),dataset.train_labels)
    print("Logistic score: " + logisticReg.score(AllMaps.flatten(1),dataset.train_labels).__str__())
    pickle.dump(logisticReg,open("logistic_classifier.pkl","wb"))
